...
def launch():
    ...
    The user can add, remove, edit, list, export, search for items, or quit the application.
    """
    ...
    while True:
        ...
        if command == 'add':
            print('\nEnter the following information. After entering the name, enter the rest of the information or type "skip" to skip any of the remaining fields.')
...
def get_inputs():
    ...
    while True:
        try:
            ...
            print('Invalid input. Please enter a valid price or enter "skip" to skip.')
    ...
    while True:
        try:
            ...
            print('Invalid input. Please enter a valid quantity or enter "skip" to skip.')
    ...
    while True:
        try:
            ...
            print('Invalid input. Please enter a valid priority or enter "skip" to skip.')
